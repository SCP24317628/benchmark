...
def parse_args():
    ...
    parser.add_argument('--tp', type=int, required=True, help='Tensor parallelism (default: 1)', default=1)
    parser.add_argument('--dp', type=int, help='Data parallelism (default: 1)', default=1)
    parser.add_argument('--pp', type=int, help='Pipeline parallelism (default: 1)', default=1)
    parser.add_argument('--ep', type=int, help='Expert parallelism (default: 1)', default=1)
    parser.add_argument('--data-type', required=True, choices=['fp16','bf16'], help='Precision type')
